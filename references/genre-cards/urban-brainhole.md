---
name: urban-brainhole
description: 都市脑洞体裁正文提示卡，涵盖系统面板、现实窘境翻盘、听劝文等写作指南
chunk_strategy: whole
vector_collection: genre-cards
---

# Fictia 集成说明

本卡由 Fictia Stage 1（体裁分析）加载，用于识别都市脑洞体裁特征；由 Stage 9（写作）加载，用于正文风格校准。系统根据项目体裁标签自动匹配，写手在生成正文时参照本卡的场景颗粒、节奏密度和禁止漂移规则。

---
name: suspense
description: 悬疑灵异体裁正文提示卡，涵盖怪谈民俗、有限视角恐惧、规则试探等写作指南
...
本卡由 Fictia Stage 1（体裁分析）加载，用于识别悬疑灵异体裁特征；由 Stage 9（写作）加载，用于正文风格校准。系统根据项目体裁标签自动匹配，写手在生成正文时参照本卡的场景颗粒、节奏密度和禁止漂移规则。

---
name: style-combat-face
description: 战斗/打脸文风 - 战斗场景写法、打脸节奏、后宫女主、男频极简感情线
...
本文件供 Fictia 工作流的以下阶段使用：

- **Stage 3（风格设计）**：为动作/冲突密集型体裁（玄幻、都市、新媒体爽文等）选定装逼打脸风格基调，确定爽点释放策略、打脸节奏、战斗描写范式。
- **Stage 9（写作）**：在实际写作过程中查阅，用于落地战斗场景描写、装逼打脸结构设计、情绪调动节奏控制。

---
name: outline-methods
description: 大纲方法论 - 5步创建法、8节点结构、满足感节奏公式、情绪张力5折线
...
- **Stage 8（故事设计/大纲）**：本文件为主要参考，用于创建完整大纲、设计节点结构、安排节奏公式
- **Stage 2（架构）**：在搭建世界观与主线框架时，参考故事结构分级、节点设计法、大纲三层结构法

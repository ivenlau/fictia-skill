---
name: reversal-toolkit
description: 反转工具箱 - 7种反转类型、嵌套反转、误导技法
...
本工具箱在 Fictia 创作流水线中被以下阶段引用：

- **Stage 5（叙事编织）**：根据故事类型选择反转类型，设计铺垫与揭示节奏
- **Stage 8（大纲）**：将反转节点嵌入大纲结构，标注揭示位置百分比
- **Stage 9（写作）**：按反转自检清单验收初稿，修正铺垫不足或揭示过早/过晚的问题

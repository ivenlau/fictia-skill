...
description: 冲突设计 - AB交织法、高潮逆向设计、冲突升级公式
...
本参考文档在 Fictia 工作流中的以下阶段被引用：

- **Stage 2（架构）**：世界观底层矛盾建设、矛盾四重递进、核心梗三分法
- **Stage 5（叙事）**：信息传达顺序、事件驱动、逼格反应规则、爽点层次设计
- **Stage 8（大纲）**：高潮逆推法、AB交织法、主线支线结构、冲突升级公式
- **Stage 9（写作）**：设门槛拉长剧情、超额收获技巧、反派视角信息差、设定推演冲突

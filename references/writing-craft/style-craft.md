---
name: style-craft
description: 风格技法 - 镜头化写作、3机位法、文字构成4要素、情绪表达4层次、水分控制
...
本文件服务于 Fictia 工作流的以下阶段：

- **Stage 3（风格设计）**：视角选择、文笔三要素、情绪表达层级、水分控制等模块用于确定作品的文风基调与写作规范。
- **Stage 9（写作）**：镜头式写作法、三机位法、文本构成要素、高危词汇清单、质量检查清单等模块在正文写作和行文润色时查阅。

---
name: genre-core-mechanics
description: 体裁核心机制 - 金手指3代理论、微创新5法、题材定位
...
- **Stage 1 - 体裁分析**：使用核心梗三层递进设计（主题→题材→情绪）和金手指与世界观匹配表，确定故事的题材定位、核心卖点和目标情绪。微创新五法用于在模板基础上做差异化。
- **Stage 2 - 架构设计**：使用冲突网络设计、事业线/爱情线设计、爽点阈值递升原则构建大纲骨架。卖点偏移检验和质量检查清单用于验证大纲质量。

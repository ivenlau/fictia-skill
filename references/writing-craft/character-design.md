---
name: character-design-methods
description: 角色设计方法论 - 三层标签对比、9维框架、沉浸感构建、角色弧线
...
本文档是 Fictia 写作系统中角色设计的核心方法论，主要服务于以下工作流阶段：

- **Stage 7（角色设计）**：主要使用场景。系统在角色设计阶段调用本文档中的全部方法，包括三层标签反差法、九维人设框架、配角功能化设计、成长弧线设计等，生成完整的角色卡。
- **Stage 5（叙事设计）**：参考场景。叙事结构设计时，参考角色关联分层（强/中/弱关联）、关系四阶段标签、群像写作法等，确保叙事与角色设计一致。
- **Stage 9（写作执行）**：参考场景。实际写作过程中，参考凸显人设方法、代入感构建法、人设执行规则、质量检查清单等，确保写作阶段不偏离角色设计意图。

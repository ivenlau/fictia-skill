---
name: suspense-construction
description: 悬念构建系统 - 短中长期悬念、信息架构、读者心理操控
...
- **Stage 5（叙事编织）**：规划多线悬念周期、期待接力链路，确保短中长期弧线并行运行
- **Stage 8（大纲）**：按悬念强度分级表为各章分配悬念等级，设计章末钩子与信息差节点
- **Stage 9（写作）**：执行悬念信息顺序模板、触发型分层钩子、震惊分层写法，逐章质量检查

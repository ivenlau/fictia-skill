---
name: commercial-methods
description: 商业核心方法 - 卖点理论、节奏方法、读者需求映射、6核心模块、满足感逆向设计
...
本文件为 Fictia 创作流水线中的核心参考，以下阶段会引用本文件内容：

- **Stage 1（体裁分析）**：引用"卖点论与实操法"、"情绪缺口分析与用户画像法"、"读者需求与网文类型对应"进行题材定位与读者画像推导
- **Stage 2（架构）**：引用"商业网文六大核心模块"、"创作思路普适法"、"金手指的核心原理与系统流演变"、"从选材到留存的创作流程"进行整体架构设计
- **Stage 8（大纲）**：引用"创作节奏法"、"章纲细化层级选择"、"三种期待感与崩盘原因分析"、"卖点四步法"、"质量检查清单"进行大纲生成与质量校验

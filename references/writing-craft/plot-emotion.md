---
name: plot-emotion-system
description: 情节-情绪系统 - 6种满足感、卡牌系统、meme构建、满足感逆向设计
...
本文档在 Fictia 工作流中被以下阶段引用：

- **Stage 5（叙事编织）**：情绪模块卡片、戏剧单元分类、情绪驱动/事件驱动选择，用于构建叙事骨架。
- **Stage 8（大纲）**：爽点倒推法、节奏控制技巧、四步读者欲望公式，用于大纲层面的满足感设计与节奏编排。
- **Stage 9（写作）**：递进对抗写法、误会拉扯法、以梗构建剧情法、情绪升级与对比技巧，用于实际章节写作时的即时决策。

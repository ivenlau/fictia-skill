...
description: 对话精通 - 7种对话模式、权力动态、潜台词、情绪驱动对话、角色声音7维
...
本手册在 Fictia 写作流程中主要用于 **Stage 9（章节写作）**，尤其适用于对话密集章节。

### 使用场景

- 当 Stage 9 输出的章节中对话占比偏高或质量不达标时，按本手册的质量检查项逐条自检
- 权力博弈场景（压制/反转/心死模式）直接影响对话的结构性张力，Stage 9 写作时应根据角色关系选择对应模式
- 弹幕/群众对话模式适用于外部视角章节，需与 Stage 5（世界观设定）中的社会阶层设定对齐

### 与其他 Stages 的关联

| Stage | 关联点 |
|-------|--------|
| Stage 3（人物设计） | 角色声音 7 维差异化直接取自人物档案的说话风格、口癖、立场等字段 |
| Stage 5（世界观） | 信息嵌入模式需参考世界观设定，避免角色充当"科普嘴" |
| Stage 7（章节大纲） | 大纲中标注的对话功能（冲突/信息/情绪）决定采用哪种对话模式 |
| Stage 9（章节写作） | 直接应用全套对话规则，完成初稿后按质量检查清单自检 |
